    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="{{ route('welcome') }}"><img src="{{ asset('assets/logo/logo.svg') }}" alt="Logo" srcset="" /></a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                @if (auth()->user()->role == 'admin')
                    ...
                    <li class="sidebar-item has-sub {{ (Request::segment(2) == 'master-data') ? 'active' : '' }}">
                        <a href="#" class="sidebar-link">
                            <i class="bi bi-stack"></i>
                            <span>Master Data</span>
                        </a>
                        <ul class="submenu">
                            <li class="submenu-item {{ (Request::segment(3) == 'job') ? 'active' : '' }}">
                                <a href="{{ route('admin.master.data.job') }}">Job</a>
                            </li>
