...
<section id="about" class="about">
    <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
            <h2>About</h2>
            <p>Description about myself</p>
        </div>

        <div class="row">
            @if ($user)
            <div class="col-lg-4">
                <img src="{{ $user->about->profile }}" class="img-fluid" alt="">
            </div>
            <div class="col-lg-8 pt-4 pt-lg-0 content">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <ul>
                            <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>{{ \Carbon\Carbon::parse($user->about->date_of_birth)->format('d F Y') }}</span></li>
                            <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span><a href="{{ $user->about->site }}" target="_blank">{{ $user->about->site }}</a></span></li>
                            <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>{{ $user->about->phone }}</span></li>
                            <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>{{ $user->about->city }}, {{ $user->about->nation }}</span></li>
                        </ul>
                    </div>
                    <div class="col-lg-6">
                        <ul>
                            <li><i class="bi bi-chevron-right"></i> <strong>Age:</strong> <span>{{ \Carbon\Carbon::parse($user->about->date_of_birth)->age }}</span></li>
                            <li><i class="bi bi-chevron-right"></i> <strong>Degree:</strong> <span>Master</span></li>
                            <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>{{ $user->email }}</span></li>
                            <li><i class="bi bi-chevron-right"></i> <strong>Freelance:</strong> <span>{{ $user->about->freelance_status }}</span></li>
                        </ul>
                    </div>
                </div>
                <p>
            ...
            @else
                ...
                <div class="col-lg-8 pt-4 pt-lg-0 content">
                    <h3>
                        UI/UX Designer &amp; Web Developer.</h3>
                    <p class="fst-italic">
